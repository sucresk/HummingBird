class Sample_Base_Egret_3D_Pick {
    ...
    private init3D() {
       ...
       // this.loadAndShowModel("resource/Lion1_LOD1.e3d", "resource/Lion.dds", "resource/Lion_nmp.dds");
        this.loadAndShowModel("resource/npc.esm", "resource/b.dds", "resource/tt.dds");
    ...
    private doPick() {
        ...
        for (var i: number = 0; i < pickList.length; ++i) {
            var mesh: BlackSwan.Mesh = <BlackSwan.Mesh>pickList[i].target;
