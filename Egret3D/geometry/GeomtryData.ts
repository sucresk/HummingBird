module Egret3D {
    export class GeomtryData {
        ...
        public static build(source: GeomtryData): GeomtryData {
            ...
            var target: GeomtryData = new GeomtryData();
            target.indices = [];
            target.vertexDatas = [];
            ...
            GeomtryData.buildFaceTangents(target);
        ...
        private static translateMaterialGroup(geomtryData: GeomtryData): GeomtryData {
        ...
        * length 15
        **/
        private static combinGeomtryData(geomtrtData: GeomtryData, needTangent:boolean = true ) {
            var index: number = 0;
            var v: number = 0;
            var n: number = 0;
            var t: number = 0;
		 ...
		 */
        private  static updateFaceNormals(geomtrtData: GeomtryData)
		{
		 ...
		 */
        private static updateVertexNormals(geomtrtData: GeomtryData)
        {
        ...
        private static buildFaceTangents(geomtryData: GeomtryData): void {
            ...
            GeomtryData.updateFaceTangents(geomtryData);
        }
        ...
        **/
		 ...
		 */
        private static updateFaceTangents(geomtrtData: GeomtryData) {
            var i: number = 0;
