module Egret3D {
    ...
    export class Camera3D extends Entity{
        ...
        public get viewProjectionMatrix(): Matrix4_4 {
          ...
          ///  this.temp.copyFrom(this._modeMatrix3D);
          ///  this.temp.append(this.projectMatrix);
          //////  }
            return this.temp;
        }
        ...
        public lookAt(pos: Vector3D, target: Vector3D, up: Vector3D = Vector3D.Y_AXIS) {
            ...
            this._modeMatrix3D.copyFrom(this._viewMatrix);

            this._tempQuat.fromMatrix(this._viewMatrix);

            var r = this._tempQuat.toEulerAngles();
            this._rot.setTo(r.x / Matrix3DUtils.DEGREES_TO_RADIANS, r.y / Matrix3DUtils.DEGREES_TO_RADIANS, r.z / Matrix3DUtils.DEGREES_TO_RADIANS);
        }
        ...
        public isVisibleToCamera(obj: Object3D): boolean {
