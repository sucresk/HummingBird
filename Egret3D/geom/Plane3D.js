...
(function (BlackSwan) {
    var Plane3D = (function () {
        ...
        Plane3D.prototype.classifyPoint = function (p, epsilon) {
            ...
            // check NaN
            if (this.d != this.d)
                return BlackSwan.PlaneClassification.FRONT;
            var len;
            if (this._iAlignment == Plane3D.ALIGN_YZ_AXIS)
            ...
            if (len < -epsilon)
                return BlackSwan.PlaneClassification.BACK;
            else if (len > epsilon)
                return BlackSwan.PlaneClassification.FRONT;
            else
                return BlackSwan.PlaneClassification.INTERSECT;
        };
