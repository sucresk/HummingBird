...
(function (BlackSwan) {
    var Quaternion = (function () {
        ...
        Quaternion.prototype.toMatrix3D = function (target) {
            if (target === void 0) { target = null; }
            var rawData = BlackSwan.Matrix3DUtils.RAW_DATA_CONTAINER;
            ...
            rawData[15] = 1;
            if (!target)
                return new BlackSwan.Matrix4_4(new Float32Array(rawData));
        ...
        Quaternion.prototype.fromMatrix = function (matrix) {
            var v = matrix.decompose(BlackSwan.Orientation3D.QUATERNION)[1];
            this.x = v.x;
            this.y = v.y;
            this.z = v.z;
            this.w = v.w;
    ...
    BlackSwan.Quaternion = Quaternion;
})(BlackSwan || (BlackSwan = {}));
