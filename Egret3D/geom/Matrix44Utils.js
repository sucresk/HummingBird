    ...
    var Matrix3DUtils = (function () {
        ...
        Matrix3DUtils.quaternion2matrix = function (quarternion, m) {
            ...
            if (m) {
                ...
                return new BlackSwan.Matrix4_4(new Float32Array(raw));
        };
        Matrix3DUtils.getForward = function (m, v) {
            if (v === void 0) { v = null; }
            //v ||= new Vector3D(0.0, 0.0, 0.0);
            if (v === null) {
                v = new BlackSwan.Vector3D(0.0, 0.0, 0.0);
            }
            m.copyColumnTo(2, v);
            v.normalize();
            return v;
        ...
        Matrix3DUtils.reflection = function (plane, target) {
            ...
            if (target === null)
                target = new BlackSwan.Matrix4_4();
        ...
        Matrix3DUtils.CALCULATION_MATRIX = new BlackSwan.Matrix4_4();
        return Matrix3DUtils;
    })();
    BlackSwan.Matrix3DUtils = Matrix3DUtils;
})(BlackSwan || (BlackSwan = {}));
//# sourceMappingURL=Matrix44Utils.js.map