module BlackSwan{
    ...
    export class Picker {
        ...
        public static pickObject3DToMinBox(camera: Camera3D, objList: Array<Object3D>): PickResult {
            ...
            var ray: Ray = new Ray();
            ray.CalculateAndTransformRay(Egret3D.canvasRectangle.width, Egret3D.canvasRectangle.height, camera.transform, camera.cameraMatrix.matrix, Egret3D.mouseX, Egret3D.mouseY);
