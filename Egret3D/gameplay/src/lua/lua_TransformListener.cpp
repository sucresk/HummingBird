...
void luaRegister_TransformListener()
{
    ...
    egret::ScriptUtil::registerClass("TransformListener", lua_members, NULL, lua_TransformListener__gc, lua_statics, scopePath);
}
...
static Transform::Listener* getInstance(lua_State* state)
{
    ...
    return (Transform::Listener*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
