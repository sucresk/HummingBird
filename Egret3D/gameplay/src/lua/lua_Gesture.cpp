...
void luaRegister_Gesture()
{
    ...
    egret::ScriptUtil::registerClass("Gesture", lua_members, NULL, lua_Gesture__gc, lua_statics, scopePath);
}
...
static Gesture* getInstance(lua_State* state)
{
    ...
    return (Gesture*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
