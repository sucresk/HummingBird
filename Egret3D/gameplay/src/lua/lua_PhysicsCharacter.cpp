...
void luaRegister_PhysicsCharacter()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsCharacter", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static PhysicsCharacter* getInstance(lua_State* state)
{
    ...
    return (PhysicsCharacter*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 2:
        {
            do
            {
                    ...
                    (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
                {
                    ...
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<PhysicsCollisionObject::CollisionListener> param1 = egret::ScriptUtil::getObjectPointer<PhysicsCollisionObject::CollisionListener>(2, "PhysicsCollisionObjectCollisionListener", false, &param1Valid);
                    if (!param1Valid)
                        break;
        ...
        case 3:
        {
            do
            {
                    ...
                    (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
                {
                    ...
                    bool param2Valid;
                    egret::ScriptUtil::LuaArray<PhysicsCollisionObject> param2 = egret::ScriptUtil::getObjectPointer<PhysicsCollisionObject>(3, "PhysicsCollisionObject", false, &param2Valid);
                    if (!param2Valid)
                        break;
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                lua_type(state, 3) == LUA_TNUMBER)
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Transform> param1 = egret::ScriptUtil::getObjectPointer<Transform>(2, "Transform", false, &param1Valid);
                if (!param1Valid)
                {
