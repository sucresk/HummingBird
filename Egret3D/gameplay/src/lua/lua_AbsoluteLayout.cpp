...
void luaRegister_AbsoluteLayout()
{
    ...
    egret::ScriptUtil::registerClass("AbsoluteLayout", lua_members, NULL, lua_AbsoluteLayout__gc, lua_statics, scopePath);
}
...
static AbsoluteLayout* getInstance(lua_State* state)
{
    ...
    return (AbsoluteLayout*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
