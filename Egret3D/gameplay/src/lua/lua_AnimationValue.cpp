...
void luaRegister_AnimationValue()
{
    ...
    egret::ScriptUtil::registerClass("AnimationValue", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static AnimationValue* getInstance(lua_State* state)
{
    ...
    return (AnimationValue*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
