...
void luaRegister_Sprite()
{
    ...
    egret::ScriptUtil::registerClass("Sprite", lua_members, NULL, lua_Sprite__gc, lua_statics, scopePath);
}
...
static Sprite* getInstance(lua_State* state)
{
    ...
    return (Sprite*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 4:
        {
            do
            {
                    ...
                    (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TTABLE || lua_type(state, 4) == LUA_TNIL))
                {
                    ...
                    // Get parameter 4 off the stack.
                    bool param4Valid;
                    egret::ScriptUtil::LuaArray<Effect> param4 = egret::ScriptUtil::getObjectPointer<Effect>(4, "Effect", false, &param4Valid);
                    if (!param4Valid)
                        break;
            ...
            do
            {
                    ...
                    (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TNIL))
                {
                    ...
                    // Get parameter 4 off the stack.
                    bool param4Valid;
                    egret::ScriptUtil::LuaArray<Rectangle> param4 = egret::ScriptUtil::getObjectPointer<Rectangle>(4, "Rectangle", true, &param4Valid);
                    if (!param4Valid)
                        break;
        ...
        case 6:
        {
            do
            {
                    ...
                    (lua_type(state, 6) == LUA_TUSERDATA || lua_type(state, 6) == LUA_TTABLE || lua_type(state, 6) == LUA_TNIL))
                {
                    ...
                    // Get parameter 6 off the stack.
                    bool param6Valid;
                    egret::ScriptUtil::LuaArray<Effect> param6 = egret::ScriptUtil::getObjectPointer<Effect>(6, "Effect", false, &param6Valid);
                    if (!param6Valid)
                        break;
