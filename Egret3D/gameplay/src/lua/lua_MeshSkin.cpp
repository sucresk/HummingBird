...
void luaRegister_MeshSkin()
{
    ...
    egret::ScriptUtil::registerClass("MeshSkin", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static MeshSkin* getInstance(lua_State* state)
{
    ...
    return (MeshSkin*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Joint> param1 = egret::ScriptUtil::getObjectPointer<Joint>(2, "Joint", false, &param1Valid);
                if (!param1Valid)
                {
