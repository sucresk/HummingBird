...
void luaRegister_RadioButton()
{
    ...
    egret::ScriptUtil::registerClass("RadioButton", lua_members, NULL, lua_RadioButton__gc, lua_statics, scopePath);
}
...
static RadioButton* getInstance(lua_State* state)
{
    ...
    return (RadioButton*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
