...
void luaRegister_AIController()
{
    ...
    egret::ScriptUtil::registerClass("AIController", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static AIController* getInstance(lua_State* state)
{
    ...
    return (AIController*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<AIMessage> param1 = egret::ScriptUtil::getObjectPointer<AIMessage>(2, "AIMessage", false, &param1Valid);
                if (!param1Valid)
                {
