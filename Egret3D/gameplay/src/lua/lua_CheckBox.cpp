...
void luaRegister_CheckBox()
{
    ...
    egret::ScriptUtil::registerClass("CheckBox", lua_members, NULL, lua_CheckBox__gc, lua_statics, scopePath);
}
...
static CheckBox* getInstance(lua_State* state)
{
    ...
    return (CheckBox*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
