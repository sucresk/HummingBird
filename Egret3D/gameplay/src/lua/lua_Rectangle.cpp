...
void luaRegister_Rectangle()
{
    ...
    egret::ScriptUtil::registerClass("Rectangle", lua_members, lua_Rectangle__init, lua_Rectangle__gc, lua_statics, scopePath);
}
...
static Rectangle* getInstance(lua_State* state)
{
    ...
    return (Rectangle*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 1:
        {
            do
            {
                if ((lua_type(state, 1) == LUA_TUSERDATA || lua_type(state, 1) == LUA_TNIL))
                {
                    ...
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Rectangle> param1 = egret::ScriptUtil::getObjectPointer<Rectangle>(1, "Rectangle", true, &param1Valid);
                    if (!param1Valid)
                        break;
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                // Get parameter 2 off the stack.
                bool param2Valid;
                egret::ScriptUtil::LuaArray<Rectangle> param2 = egret::ScriptUtil::getObjectPointer<Rectangle>(2, "Rectangle", true, &param2Valid);
                if (!param2Valid)
                {
                ...
                // Get parameter 3 off the stack.
                bool param3Valid;
                egret::ScriptUtil::LuaArray<Rectangle> param3 = egret::ScriptUtil::getObjectPointer<Rectangle>(3, "Rectangle", false, &param3Valid);
                if (!param3Valid)
                {
