...
void luaRegister_AnimationClip()
{
    ...
    egret::ScriptUtil::registerClass("AnimationClip", lua_members, NULL, lua_AnimationClip__gc, lua_statics, scopePath);
}
...
static AnimationClip* getInstance(lua_State* state)
{
    ...
    return (AnimationClip*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                bool param1Valid;
                egret::ScriptUtil::LuaArray<AnimationClip::Listener> param1 = egret::ScriptUtil::getObjectPointer<AnimationClip::Listener>(2, "AnimationClipListener", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                lua_type(state, 3) == LUA_TNUMBER)
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<AnimationClip> param1 = egret::ScriptUtil::getObjectPointer<AnimationClip>(2, "AnimationClip", false, &param1Valid);
                if (!param1Valid)
                {
