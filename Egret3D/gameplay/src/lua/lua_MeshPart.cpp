...
void luaRegister_MeshPart()
{
    ...
    egret::ScriptUtil::registerClass("MeshPart", lua_members, NULL, lua_MeshPart__gc, lua_statics, scopePath);
}
...
static MeshPart* getInstance(lua_State* state)
{
    ...
    return (MeshPart*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
