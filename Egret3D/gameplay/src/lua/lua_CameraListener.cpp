...
void luaRegister_CameraListener()
{
    ...
    egret::ScriptUtil::registerClass("CameraListener", lua_members, NULL, lua_CameraListener__gc, lua_statics, scopePath);
}
...
static Camera::Listener* getInstance(lua_State* state)
{
    ...
    return (Camera::Listener*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
