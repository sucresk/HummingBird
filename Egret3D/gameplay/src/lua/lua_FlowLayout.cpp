...
void luaRegister_FlowLayout()
{
    ...
    egret::ScriptUtil::registerClass("FlowLayout", lua_members, NULL, lua_FlowLayout__gc, lua_statics, scopePath);
}
...
static FlowLayout* getInstance(lua_State* state)
{
    ...
    return (FlowLayout*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
