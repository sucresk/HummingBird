...
void luaRegister_DepthStencilTarget()
{
    ...
    egret::ScriptUtil::registerClass("DepthStencilTarget", lua_members, NULL, lua_DepthStencilTarget__gc, lua_statics, scopePath);
}
...
static DepthStencilTarget* getInstance(lua_State* state)
{
    ...
    return (DepthStencilTarget*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
