...
void luaRegister_ThemeSideRegions()
{
    ...
    egret::ScriptUtil::registerClass("ThemeSideRegions", lua_members, lua_ThemeSideRegions__init, lua_ThemeSideRegions__gc, lua_statics, scopePath);
}
...
static Theme::SideRegions* getInstance(lua_State* state)
{
    ...
    return (Theme::SideRegions*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
