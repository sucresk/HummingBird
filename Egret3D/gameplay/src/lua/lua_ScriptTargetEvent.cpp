...
void luaRegister_ScriptTargetEvent()
{
    ...
    egret::ScriptUtil::registerClass("ScriptTargetEvent", lua_members, lua_ScriptTargetEvent__init, lua_ScriptTargetEvent__gc, lua_statics, scopePath);
}
...
static ScriptTarget::Event* getInstance(lua_State* state)
{
    ...
    return (ScriptTarget::Event*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
