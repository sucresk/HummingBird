...
void luaRegister_Text()
{
    ...
    egret::ScriptUtil::registerClass("Text", lua_members, NULL, lua_Text__gc, lua_statics, scopePath);
}
...
static Text* getInstance(lua_State* state)
{
    ...
    return (Text*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 3:
        {
            do
            {
                    ...
                    (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TNIL))
                {
                    ...
                    // Get parameter 3 off the stack.
                    bool param3Valid;
                    egret::ScriptUtil::LuaArray<Vector4> param3 = egret::ScriptUtil::getObjectPointer<Vector4>(3, "Vector4", true, &param3Valid);
                    if (!param3Valid)
                        break;
