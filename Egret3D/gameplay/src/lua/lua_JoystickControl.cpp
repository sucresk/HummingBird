...
void luaRegister_JoystickControl()
{
    ...
    egret::ScriptUtil::registerClass("JoystickControl", lua_members, NULL, lua_JoystickControl__gc, lua_statics, scopePath);
}
...
static JoystickControl* getInstance(lua_State* state)
{
    ...
    return (JoystickControl*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                lua_type(state, 3) == LUA_TNUMBER)
            {
                ...
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Control::Listener> param1 = egret::ScriptUtil::getObjectPointer<Control::Listener>(2, "ControlListener", false, &param1Valid);
                if (!param1Valid)
                {
...
int lua_JoystickControl_getInnerRegionSize(lua_State* state)
{
    ...
    switch (paramCount)
    {
        ...
        case 2:
        {
            ...
            {
                // Get parameter 1 off the stack.
                egret::ScriptUtil::LuaArray<bool> param1 = egret::ScriptUtil::getBoolPointer(2);
        ...
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TLIGHTUSERDATA))
            {
                ...
                // Get parameter 2 off the stack.
                egret::ScriptUtil::LuaArray<bool> param2 = egret::ScriptUtil::getBoolPointer(3);
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Control> param1 = egret::ScriptUtil::getObjectPointer<Control>(2, "Control", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Font> param1 = egret::ScriptUtil::getObjectPointer<Font>(2, "Font", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Theme::Style> param1 = egret::ScriptUtil::getObjectPointer<Theme::Style>(2, "ThemeStyle", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        ...
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                // Get parameter 2 off the stack.
                bool param2Valid;
                egret::ScriptUtil::LuaArray<Theme::Style> param2 = egret::ScriptUtil::getObjectPointer<Theme::Style>(2, "ThemeStyle", false, &param2Valid);
                if (!param2Valid)
                {
