...
void luaRegister_Terrain()
{
    ...
    egret::ScriptUtil::registerClass("Terrain", lua_members, NULL, lua_Terrain__gc, lua_statics, scopePath);
}
...
static Terrain* getInstance(lua_State* state)
{
    ...
    return (Terrain*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 6:
        {
            do
            {
                    ...
                    (lua_type(state, 6) == LUA_TSTRING || lua_type(state, 6) == LUA_TNIL))
                {
                    ...
                    const char* param6 = egret::ScriptUtil::getString(6, false);
        ...
        case 7:
        {
            do
            {
                    ...
                    (lua_type(state, 7) == LUA_TSTRING || lua_type(state, 7) == LUA_TNIL))
                {
                    ...
                    const char* param7 = egret::ScriptUtil::getString(7, false);
