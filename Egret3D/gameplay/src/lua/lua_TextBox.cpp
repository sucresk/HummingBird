...
void luaRegister_TextBox()
{
    ...
    egret::ScriptUtil::registerClass("TextBox", lua_members, NULL, lua_TextBox__gc, lua_statics, scopePath);
}
...
static TextBox* getInstance(lua_State* state)
{
    ...
    return (TextBox*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
