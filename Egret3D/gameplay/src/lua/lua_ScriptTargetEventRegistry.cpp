...
void luaRegister_ScriptTargetEventRegistry()
{
    ...
    egret::ScriptUtil::registerClass("ScriptTargetEventRegistry", lua_members, lua_ScriptTargetEventRegistry__init, lua_ScriptTargetEventRegistry__gc, lua_statics, scopePath);
}
...
static ScriptTarget::EventRegistry* getInstance(lua_State* state)
{
    ...
    return (ScriptTarget::EventRegistry*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
