...
void luaRegister_PhysicsCollisionShape()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsCollisionShape", lua_members, NULL, lua_PhysicsCollisionShape__gc, lua_statics, scopePath);
}
...
static PhysicsCollisionShape* getInstance(lua_State* state)
{
    ...
    return (PhysicsCollisionShape*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 1:
        {
            do
            {
                if ((lua_type(state, 1) == LUA_TUSERDATA || lua_type(state, 1) == LUA_TTABLE || lua_type(state, 1) == LUA_TNIL))
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<HeightField> param1 = egret::ScriptUtil::getObjectPointer<HeightField>(1, "HeightField", false, &param1Valid);
                    if (!param1Valid)
                        break;
