...
void luaRegister_Camera()
{
    ...
    egret::ScriptUtil::registerClass("Camera", lua_members, NULL, lua_Camera__gc, lua_statics, scopePath);
}
...
static Camera* getInstance(lua_State* state)
{
    ...
    return (Camera*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Camera::Listener> param1 = egret::ScriptUtil::getObjectPointer<Camera::Listener>(2, "CameraListener", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 5:
        {
                ...
                (lua_type(state, 5) == LUA_TUSERDATA || lua_type(state, 5) == LUA_TTABLE || lua_type(state, 5) == LUA_TNIL))
            {
                ...
                bool param4Valid;
                egret::ScriptUtil::LuaArray<Ray> param4 = egret::ScriptUtil::getObjectPointer<Ray>(5, "Ray", false, &param4Valid);
                if (!param4Valid)
                {
        ...
        case 4:
        {
            do
            {
                    ...
                    (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TTABLE || lua_type(state, 4) == LUA_TNIL))
                {
                    ...
                    // Get parameter 3 off the stack.
                    bool param3Valid;
                    egret::ScriptUtil::LuaArray<Vector2> param3 = egret::ScriptUtil::getObjectPointer<Vector2>(4, "Vector2", false, &param3Valid);
                    if (!param3Valid)
                        break;
