...
void luaRegister_Font()
{
    ...
    egret::ScriptUtil::registerClass("Font", lua_members, NULL, lua_Font__gc, lua_statics, scopePath);
}
...
static Font* getInstance(lua_State* state)
{
    ...
    return (Font*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 7:
        {
            do
            {
                    ...
                    lua_type(state, 7) == LUA_TBOOLEAN)
                {
                    ...
                    bool param6 = egret::ScriptUtil::luaCheckBool(state, 7);
        ...
        case 8:
        {
            ...
            do
            {
                    ...
                    lua_type(state, 8) == LUA_TBOOLEAN)
                {
                    ...
                    // Get parameter 7 off the stack.
                    bool param7 = egret::ScriptUtil::luaCheckBool(state, 8);
        ...
        case 9:
        {
            ...
            do
            {
                    ...
                    (lua_type(state, 9) == LUA_TUSERDATA || lua_type(state, 9) == LUA_TNIL))
                {
                    ...
                    // Get parameter 8 off the stack.
                    bool param8Valid;
                    egret::ScriptUtil::LuaArray<Rectangle> param8 = egret::ScriptUtil::getObjectPointer<Rectangle>(9, "Rectangle", true, &param8Valid);
                    if (!param8Valid)
                        break;
        ...
        case 10:
        {
            do
            {
                    ...
                    lua_type(state, 10) == LUA_TBOOLEAN)
                {
                    ...
                    bool param9 = egret::ScriptUtil::luaCheckBool(state, 10);
    ...
    switch (paramCount)
    {
        case 6:
        {
                ...
                (lua_type(state, 6) == LUA_TUSERDATA || lua_type(state, 6) == LUA_TTABLE || lua_type(state, 6) == LUA_TNIL))
            {
                ...
                // Get parameter 4 off the stack.
                bool param4Valid;
                egret::ScriptUtil::LuaArray<Vector2> param4 = egret::ScriptUtil::getObjectPointer<Vector2>(5, "Vector2", true, &param4Valid);
                if (!param4Valid)
                {
                ...
                // Get parameter 5 off the stack.
                bool param5Valid;
                egret::ScriptUtil::LuaArray<Vector2> param5 = egret::ScriptUtil::getObjectPointer<Vector2>(6, "Vector2", false, &param5Valid);
                if (!param5Valid)
                {
        ...
        case 9:
        {
                ...
                lua_type(state, 9) == LUA_TBOOLEAN)
            {
                ...
                // Get parameter 8 off the stack.
                bool param8 = egret::ScriptUtil::luaCheckBool(state, 9);
    ...
    switch (paramCount)
    {
        case 6:
        {
                ...
                lua_type(state, 6) == LUA_TNUMBER)
            {
                ...
                // Get parameter 4 off the stack.
                bool param4Valid;
                egret::ScriptUtil::LuaArray<Vector2> param4 = egret::ScriptUtil::getObjectPointer<Vector2>(5, "Vector2", false, &param4Valid);
                if (!param4Valid)
                {
                    lua_pushstring(state, "Failed to convert parameter 4 to type 'Vector2'.");
                    lua_error(state);
        ...
        case 5:
        {
            do
            {
                    ...
                    (lua_type(state, 5) == LUA_TTABLE || lua_type(state, 5) == LUA_TLIGHTUSERDATA))
                {
                    ...
                    // Get parameter 3 off the stack.
                    egret::ScriptUtil::LuaArray<unsigned int> param3 = egret::ScriptUtil::getUnsignedIntPointer(4);
            ...
            do
            {
                    ...
                    (lua_type(state, 5) == LUA_TUSERDATA || lua_type(state, 5) == LUA_TTABLE || lua_type(state, 5) == LUA_TNIL))
                {
                    ...
                    // Get parameter 4 off the stack.
                    bool param4Valid;
                    egret::ScriptUtil::LuaArray<Rectangle> param4 = egret::ScriptUtil::getObjectPointer<Rectangle>(5, "Rectangle", false, &param4Valid);
                    if (!param4Valid)
                        break;
