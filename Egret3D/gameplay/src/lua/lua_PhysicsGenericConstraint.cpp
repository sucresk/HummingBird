...
void luaRegister_PhysicsGenericConstraint()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsGenericConstraint", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static PhysicsGenericConstraint* getInstance(lua_State* state)
{
    ...
    return (PhysicsGenericConstraint*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
