...
void luaRegister_AudioBuffer()
{
    ...
    egret::ScriptUtil::registerClass("AudioBuffer", lua_members, NULL, lua_AudioBuffer__gc, lua_statics, scopePath);
}
...
static AudioBuffer* getInstance(lua_State* state)
{
    ...
    return (AudioBuffer*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
