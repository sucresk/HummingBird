...
void luaRegister_Texture()
{
    ...
    egret::ScriptUtil::registerClass("Texture", lua_members, NULL, lua_Texture__gc, lua_statics, scopePath);
}
...
static Texture* getInstance(lua_State* state)
{
    ...
    return (Texture*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TLIGHTUSERDATA))
            {
                ...
                egret::ScriptUtil::LuaArray<unsigned char> param1 = egret::ScriptUtil::getUnsignedCharPointer(2);
        ...
        case 1:
        {
            ...
            do
            {
                if ((lua_type(state, 1) == LUA_TUSERDATA || lua_type(state, 1) == LUA_TTABLE || lua_type(state, 1) == LUA_TNIL))
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Image> param1 = egret::ScriptUtil::getObjectPointer<Image>(1, "Image", false, &param1Valid);
                    if (!param1Valid)
                        break;
        ...
        case 2:
        {
            do
            {
                    ...
                    lua_type(state, 2) == LUA_TBOOLEAN)
                {
                    ...
                    bool param2 = egret::ScriptUtil::luaCheckBool(state, 2);
        ...
        case 3:
        {
            do
            {
                    ...
                    lua_type(state, 3) == LUA_TNUMBER)
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<GLuint> param1 = egret::ScriptUtil::getObjectPointer<GLuint>(1, "GLuint", true, &param1Valid);
                    if (!param1Valid)
                        break;
        ...
        case 4:
        {
            do
            {
                    ...
                    (lua_type(state, 4) == LUA_TTABLE || lua_type(state, 4) == LUA_TLIGHTUSERDATA))
                {
                    ...
                    egret::ScriptUtil::LuaArray<unsigned char> param4 = egret::ScriptUtil::getUnsignedCharPointer(4);
        ...
        case 5:
        {
            do
            {
                    ...
                    lua_type(state, 5) == LUA_TBOOLEAN)
                {
                    ...
                    bool param5 = egret::ScriptUtil::luaCheckBool(state, 5);
