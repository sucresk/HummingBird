...
void luaRegister_Mesh()
{
    ...
    egret::ScriptUtil::registerClass("Mesh", lua_members, NULL, lua_Mesh__gc, lua_statics, scopePath);
}
...
static Mesh* getInstance(lua_State* state)
{
    ...
    return (Mesh*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        ...
        case 5:
        {
                ...
                lua_type(state, 5) == LUA_TBOOLEAN)
            {
                ...
                bool param4 = egret::ScriptUtil::luaCheckBool(state, 5);
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TNUMBER)
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Vector3> param1 = egret::ScriptUtil::getObjectPointer<Vector3>(1, "Vector3", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TNUMBER)
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<VertexFormat> param1 = egret::ScriptUtil::getObjectPointer<VertexFormat>(1, "VertexFormat", true, &param1Valid);
                if (!param1Valid)
                {
        ...
        case 3:
        {
                ...
                lua_type(state, 3) == LUA_TBOOLEAN)
            {
                ...
                // Get parameter 3 off the stack.
                bool param3 = egret::ScriptUtil::luaCheckBool(state, 3);
