...
void luaRegister_BoundingBox()
{
    ...
    egret::ScriptUtil::registerClass("BoundingBox", lua_members, lua_BoundingBox__init, lua_BoundingBox__gc, lua_statics, scopePath);
}
...
static BoundingBox* getInstance(lua_State* state)
{
    ...
    return (BoundingBox*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 1:
        {
            do
            {
                if ((lua_type(state, 1) == LUA_TUSERDATA || lua_type(state, 1) == LUA_TNIL))
                {
                    ...
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<BoundingBox> param1 = egret::ScriptUtil::getObjectPointer<BoundingBox>(1, "BoundingBox", true, &param1Valid);
                    if (!param1Valid)
                        break;
        ...
        case 1:
        {
            do
            {
                if ((lua_type(state, 1) == LUA_TUSERDATA))
                {
					...
					memcpy(returnPtr, &instance->getCenter(), sizeof(float) * 3);
                    if (returnPtr)
                    {
                        egret::ScriptUtil::LuaObject* object = (egret::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(egret::ScriptUtil::LuaObject));
                        object->instance = returnPtr;
...
int lua_BoundingBox_max(lua_State* state)
{
    ...
    else
    {
		...
		void *returnPtr = (void*)new kmVec3;
		memcpy(returnPtr, &instance->max, sizeof(float) * 3);
        if (returnPtr)
        {
            egret::ScriptUtil::LuaObject* object = (egret::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(egret::ScriptUtil::LuaObject));
            object->instance = returnPtr;
...
int lua_BoundingBox_min(lua_State* state)
{
    ...
    else
    {
		...
		void *returnPtr = (void*)new kmVec3;
		memcpy(returnPtr, &instance->min, sizeof(float) * 3);
        if (returnPtr)
        {
            egret::ScriptUtil::LuaObject* object = (egret::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(egret::ScriptUtil::LuaObject));
            object->instance = returnPtr;
