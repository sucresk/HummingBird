...
void luaRegister_Transform()
{
    ...
    egret::ScriptUtil::registerClass("Transform", lua_members, lua_Transform__init, lua_Transform__gc, lua_statics, scopePath);
}
...
static Transform* getInstance(lua_State* state)
{
    ...
    return (Transform*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 1:
        {
            do
            {
                if ((lua_type(state, 1) == LUA_TUSERDATA || lua_type(state, 1) == LUA_TNIL))
                {
                    ...
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Transform> param1 = egret::ScriptUtil::getObjectPointer<Transform>(1, "Transform", true, &param1Valid);
                    if (!param1Valid)
                        break;
