...
void luaRegister_TerrainPatch()
{
    ...
    egret::ScriptUtil::registerClass("TerrainPatch", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static TerrainPatch* getInstance(lua_State* state)
{
    ...
    return (TerrainPatch*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
