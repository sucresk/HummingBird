...
void luaRegister_Ray()
{
    ...
    egret::ScriptUtil::registerClass("Ray", lua_members, lua_Ray__init, lua_Ray__gc, lua_statics, scopePath);
}
...
static Ray* getInstance(lua_State* state)
{
    ...
    return (Ray*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 1:
        {
            do
            {
                if ((lua_type(state, 1) == LUA_TUSERDATA || lua_type(state, 1) == LUA_TNIL))
                {
                    ...
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Ray> param1 = egret::ScriptUtil::getObjectPointer<Ray>(1, "Ray", true, &param1Valid);
                    if (!param1Valid)
                        break;
