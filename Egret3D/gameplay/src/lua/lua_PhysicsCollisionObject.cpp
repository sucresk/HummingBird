...
void luaRegister_PhysicsCollisionObject()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsCollisionObject", lua_members, NULL, lua_PhysicsCollisionObject__gc, lua_statics, scopePath);
}
...
static PhysicsCollisionObject* getInstance(lua_State* state)
{
    ...
    return (PhysicsCollisionObject*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
