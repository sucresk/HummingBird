...
void luaRegister_RenderState()
{
    ...
    egret::ScriptUtil::registerClass("RenderState", lua_members, NULL, lua_RenderState__gc, lua_statics, scopePath);
}
...
static RenderState* getInstance(lua_State* state)
{
    ...
    return (RenderState*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
