...
void luaRegister_AudioController()
{
    ...
    egret::ScriptUtil::registerClass("AudioController", lua_members, NULL, lua_AudioController__gc, lua_statics, scopePath);
}
...
static AudioController* getInstance(lua_State* state)
{
    ...
    return (AudioController*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
