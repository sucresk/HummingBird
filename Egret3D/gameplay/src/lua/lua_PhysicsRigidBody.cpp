...
void luaRegister_PhysicsRigidBody()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsRigidBody", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static PhysicsRigidBody* getInstance(lua_State* state)
{
    ...
    return (PhysicsRigidBody*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
