...
void luaRegister_VertexFormatElement()
{
    ...
    egret::ScriptUtil::registerClass("VertexFormatElement", lua_members, lua_VertexFormatElement__init, lua_VertexFormatElement__gc, lua_statics, scopePath);
}
...
static VertexFormat::Element* getInstance(lua_State* state)
{
    ...
    return (VertexFormat::Element*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
