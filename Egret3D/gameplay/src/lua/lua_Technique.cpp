...
void luaRegister_Technique()
{
    ...
    egret::ScriptUtil::registerClass("Technique", lua_members, NULL, lua_Technique__gc, lua_statics, scopePath);
}
...
static Technique* getInstance(lua_State* state)
{
    ...
    return (Technique*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
