...
void luaRegister_AIAgentListener()
{
    ...
    egret::ScriptUtil::registerClass("AIAgentListener", lua_members, NULL, lua_AIAgentListener__gc, lua_statics, scopePath);
}
...
static AIAgent::Listener* getInstance(lua_State* state)
{
    ...
    return (AIAgent::Listener*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
