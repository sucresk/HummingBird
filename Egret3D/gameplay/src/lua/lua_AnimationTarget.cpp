...
void luaRegister_AnimationTarget()
{
    ...
    egret::ScriptUtil::registerClass("AnimationTarget", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static AnimationTarget* getInstance(lua_State* state)
{
    ...
    return (AnimationTarget*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
