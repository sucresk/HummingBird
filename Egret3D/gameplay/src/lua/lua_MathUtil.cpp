...
void luaRegister_MathUtil()
{
    ...
    egret::ScriptUtil::registerClass("MathUtil", lua_members, NULL, lua_MathUtil__gc, lua_statics, scopePath);
}
...
static MathUtil* getInstance(lua_State* state)
{
    ...
    return (MathUtil*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
