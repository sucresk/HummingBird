...
void luaRegister_Frustum()
{
    ...
    egret::ScriptUtil::registerClass("Frustum", lua_members, lua_Frustum__init, lua_Frustum__gc, lua_statics, scopePath);
}
...
static Frustum* getInstance(lua_State* state)
{
    ...
    return (Frustum*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 1:
        {
            ...
            do
            {
                if ((lua_type(state, 1) == LUA_TUSERDATA || lua_type(state, 1) == LUA_TNIL))
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Frustum> param1 = egret::ScriptUtil::getObjectPointer<Frustum>(1, "Frustum", true, &param1Valid);
                    if (!param1Valid)
                        break;
