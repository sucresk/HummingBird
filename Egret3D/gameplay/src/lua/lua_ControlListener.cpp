...
void luaRegister_ControlListener()
{
    ...
    egret::ScriptUtil::registerClass("ControlListener", lua_members, NULL, lua_ControlListener__gc, lua_statics, scopePath);
}
...
static Control::Listener* getInstance(lua_State* state)
{
    ...
    return (Control::Listener*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
