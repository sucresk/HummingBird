...
void luaRegister_PhysicsController()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsController", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static PhysicsController* getInstance(lua_State* state)
{
    ...
    return (PhysicsController*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<PhysicsController::Listener> param1 = egret::ScriptUtil::getObjectPointer<PhysicsController::Listener>(2, "PhysicsControllerListener", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<PhysicsRigidBody> param1 = egret::ScriptUtil::getObjectPointer<PhysicsRigidBody>(2, "PhysicsRigidBody", false, &param1Valid);
                if (!param1Valid)
                {
        ...
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                // Get parameter 2 off the stack.
                bool param2Valid;
                egret::ScriptUtil::LuaArray<PhysicsRigidBody> param2 = egret::ScriptUtil::getObjectPointer<PhysicsRigidBody>(3, "PhysicsRigidBody", false, &param2Valid);
                if (!param2Valid)
                {
        ...
        case 5:
        {
            do
            {
                    ...
                    (lua_type(state, 5) == LUA_TUSERDATA || lua_type(state, 5) == LUA_TTABLE || lua_type(state, 5) == LUA_TNIL))
                {
                    ...
                    bool param4Valid;
                    egret::ScriptUtil::LuaArray<PhysicsRigidBody> param4 = egret::ScriptUtil::getObjectPointer<PhysicsRigidBody>(5, "PhysicsRigidBody", false, &param4Valid);
                    if (!param4Valid)
                        break;
        ...
        case 7:
        {
            do
            {
                    ...
                    (lua_type(state, 7) == LUA_TUSERDATA || lua_type(state, 7) == LUA_TNIL))
                {
                    ...
                    bool param6Valid;
                    egret::ScriptUtil::LuaArray<kmVec3> param6 = egret::ScriptUtil::getObjectPointer<kmVec3>(7, "kmVec3", true, &param6Valid);
                    if (!param6Valid)
                        break;
    ...
    switch (paramCount)
    {
        ...
        case 7:
        {
                ...
                (lua_type(state, 7) == LUA_TUSERDATA || lua_type(state, 7) == LUA_TNIL))
            {
                ...
                if (!param6Valid)
                {
                    lua_pushstring(state, "Failed to convert parameter 6 to type 'kmVec3'.");
                    lua_error(state);
                }
        ...
        case 4:
        {
            do
            {
                    ...
                    (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TTABLE || lua_type(state, 4) == LUA_TNIL))
                {
                    ...
                    // Get parameter 3 off the stack.
                    bool param3Valid;
                    egret::ScriptUtil::LuaArray<PhysicsRigidBody> param3 = egret::ScriptUtil::getObjectPointer<PhysicsRigidBody>(4, "PhysicsRigidBody", false, &param3Valid);
                    if (!param3Valid)
                        break;
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                lua_type(state, 3) == LUA_TNUMBER)
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Ray> param1 = egret::ScriptUtil::getObjectPointer<Ray>(2, "Ray", true, &param1Valid);
                if (!param1Valid)
                {
        ...
        case 4:
        {
                ...
                (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TTABLE || lua_type(state, 4) == LUA_TNIL))
            {
                ...
                // Get parameter 3 off the stack.
                bool param3Valid;
                egret::ScriptUtil::LuaArray<PhysicsController::HitResult> param3 = egret::ScriptUtil::getObjectPointer<PhysicsController::HitResult>(4, "PhysicsControllerHitResult", false, &param3Valid);
                if (!param3Valid)
                {
        ...
        case 5:
        {
                ...
                (lua_type(state, 5) == LUA_TUSERDATA || lua_type(state, 5) == LUA_TTABLE || lua_type(state, 5) == LUA_TNIL))
            {
                ...
                // Get parameter 4 off the stack.
                bool param4Valid;
                egret::ScriptUtil::LuaArray<PhysicsController::HitFilter> param4 = egret::ScriptUtil::getObjectPointer<PhysicsController::HitFilter>(5, "PhysicsControllerHitFilter", false, &param4Valid);
                if (!param4Valid)
                {
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<PhysicsCollisionObject> param1 = egret::ScriptUtil::getObjectPointer<PhysicsCollisionObject>(2, "PhysicsCollisionObject", false, &param1Valid);
                if (!param1Valid)
                {
