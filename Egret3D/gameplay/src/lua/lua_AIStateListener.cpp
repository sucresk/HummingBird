...
void luaRegister_AIStateListener()
{
    ...
    egret::ScriptUtil::registerClass("AIStateListener", lua_members, lua_AIStateListener__init, lua_AIStateListener__gc, lua_statics, scopePath);
}
...
static AIState::Listener* getInstance(lua_State* state)
{
    ...
    return (AIState::Listener*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                bool param2Valid;
                egret::ScriptUtil::LuaArray<AIState> param2 = egret::ScriptUtil::getObjectPointer<AIState>(3, "AIState", false, &param2Valid);
                if (!param2Valid)
                {
