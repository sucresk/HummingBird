...
void luaRegister_Platform()
{
    ...
    egret::ScriptUtil::registerClass("Platform", lua_members, NULL, lua_Platform__gc, lua_statics, scopePath);
}
...
static Platform* getInstance(lua_State* state)
{
    ...
    return (Platform*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
