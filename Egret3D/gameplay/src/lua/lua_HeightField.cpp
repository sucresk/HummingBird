...
void luaRegister_HeightField()
{
    ...
    egret::ScriptUtil::registerClass("HeightField", lua_members, NULL, lua_HeightField__gc, lua_statics, scopePath);
}
...
static HeightField* getInstance(lua_State* state)
{
    ...
    return (HeightField*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
