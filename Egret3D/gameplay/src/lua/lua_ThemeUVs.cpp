...
void luaRegister_ThemeUVs()
{
    ...
    egret::ScriptUtil::registerClass("ThemeUVs", lua_members, lua_ThemeUVs__init, lua_ThemeUVs__gc, lua_statics, scopePath);
}
...
static Theme::UVs* getInstance(lua_State* state)
{
    ...
    return (Theme::UVs*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
