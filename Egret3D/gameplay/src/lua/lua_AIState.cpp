...
void luaRegister_AIState()
{
    ...
    egret::ScriptUtil::registerClass("AIState", lua_members, NULL, lua_AIState__gc, lua_statics, scopePath);
}
...
static AIState* getInstance(lua_State* state)
{
    ...
    return (AIState*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                bool param1Valid;
                egret::ScriptUtil::LuaArray<AIState::Listener> param1 = egret::ScriptUtil::getObjectPointer<AIState::Listener>(2, "AIStateListener", false, &param1Valid);
                if (!param1Valid)
                {
