...
void luaRegister_MaterialParameter()
{
    ...
    egret::ScriptUtil::registerClass("MaterialParameter", lua_members, NULL, lua_MaterialParameter__gc, lua_statics, scopePath);
}
...
static MaterialParameter* getInstance(lua_State* state)
{
    ...
    return (MaterialParameter*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
...
int lua_MaterialParameter_setIntArray(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 3:
        {
            ...
            {
                // Get parameter 1 off the stack.
                egret::ScriptUtil::LuaArray<int> param1 = egret::ScriptUtil::getIntPointer(2);
        ...
        case 2:
        {
            do
            {
                    ...
                    (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Texture::Sampler> param1 = egret::ScriptUtil::getObjectPointer<Texture::Sampler>(2, "TextureSampler", false, &param1Valid);
                    if (!param1Valid)
                        break;
        ...
        case 2:
        {
            ...
            do
            {
                    ...
                    (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Vector2> param1 = egret::ScriptUtil::getObjectPointer<Vector2>(2, "Vector2", false, &param1Valid);
                    if (!param1Valid)
                        break;
            ...
            do
            {
                    ...
                    (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Vector4> param1 = egret::ScriptUtil::getObjectPointer<Vector4>(2, "Vector4", false, &param1Valid);
                    if (!param1Valid)
                        break;
