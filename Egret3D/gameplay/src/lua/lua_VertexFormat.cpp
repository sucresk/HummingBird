...
void luaRegister_VertexFormat()
{
    ...
    egret::ScriptUtil::registerClass("VertexFormat", lua_members, lua_VertexFormat__init, lua_VertexFormat__gc, lua_statics, scopePath);
}
...
static VertexFormat* getInstance(lua_State* state)
{
    ...
    return (VertexFormat*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                lua_type(state, 2) == LUA_TNUMBER)
            {
                ...
                bool param1Valid;
                egret::ScriptUtil::LuaArray<VertexFormat::Element> param1 = egret::ScriptUtil::getObjectPointer<VertexFormat::Element>(1, "VertexFormatElement", false, &param1Valid);
                if (!param1Valid)
                {
