...
void luaRegister_ThemeThemeImage()
{
    ...
    egret::ScriptUtil::registerClass("ThemeThemeImage", lua_members, NULL, lua_ThemeThemeImage__gc, lua_statics, scopePath);
}
...
static Theme::ThemeImage* getInstance(lua_State* state)
{
    ...
    return (Theme::ThemeImage*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
