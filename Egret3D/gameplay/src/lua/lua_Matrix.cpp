...
static Matrix* getInstance(lua_State* state)
{
    ...
    return (Matrix*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 4:
        {
                ...
                (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TTABLE || lua_type(state, 4) == LUA_TNIL))
            {
                ...
                // Get parameter 2 off the stack.
                bool param2Valid;
                egret::ScriptUtil::LuaArray<Quaternion> param2 = egret::ScriptUtil::getObjectPointer<Quaternion>(3, "Quaternion", false, &param2Valid);
                if (!param2Valid)
                {
                ...
                // Get parameter 3 off the stack.
                bool param3Valid;
                egret::ScriptUtil::LuaArray<Vector3> param3 = egret::ScriptUtil::getObjectPointer<Vector3>(4, "Vector3", false, &param3Valid);
                if (!param3Valid)
                {
        ...
        case 4:
        {
            do
            {
                    ...
                    (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TTABLE || lua_type(state, 4) == LUA_TNIL))
                {
                    ...
                    // Get parameter 3 off the stack.
                    bool param3Valid;
                    egret::ScriptUtil::LuaArray<Matrix> param3 = egret::ScriptUtil::getObjectPointer<Matrix>(4, "Matrix", false, &param3Valid);
                    if (!param3Valid)
                        break;
        ...
        case 5:
        {
            do
            {
                    ...
                    (lua_type(state, 5) == LUA_TUSERDATA || lua_type(state, 5) == LUA_TTABLE || lua_type(state, 5) == LUA_TNIL))
                {
                    ...
                    // Get parameter 4 off the stack.
                    bool param4Valid;
                    egret::ScriptUtil::LuaArray<Matrix> param4 = egret::ScriptUtil::getObjectPointer<Matrix>(5, "Matrix", false, &param4Valid);
                    if (!param4Valid)
                        break;
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                // Get parameter 3 off the stack.
                bool param3Valid;
                egret::ScriptUtil::LuaArray<Matrix> param3 = egret::ScriptUtil::getObjectPointer<Matrix>(3, "Matrix", false, &param3Valid);
                if (!param3Valid)
                {
        ...
        case 4:
        {
            do
            {
                    ...
                    (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TTABLE || lua_type(state, 4) == LUA_TNIL))
                {
                    ...
                    // Get parameter 4 off the stack.
                    bool param4Valid;
                    egret::ScriptUtil::LuaArray<Matrix> param4 = egret::ScriptUtil::getObjectPointer<Matrix>(4, "Matrix", false, &param4Valid);
                    if (!param4Valid)
                        break;
        ...
        case 5:
        {
            do
            {
                    ...
                    (lua_type(state, 5) == LUA_TUSERDATA || lua_type(state, 5) == LUA_TTABLE || lua_type(state, 5) == LUA_TNIL))
                {
                    ...
                    // Get parameter 4 off the stack.
                    bool param4Valid;
                    egret::ScriptUtil::LuaArray<Vector3> param4 = egret::ScriptUtil::getObjectPointer<Vector3>(4, "Vector3", true, &param4Valid);
                    if (!param4Valid)
                        break;

                    // Get parameter 5 off the stack.
                    bool param5Valid;
                    egret::ScriptUtil::LuaArray<Matrix> param5 = egret::ScriptUtil::getObjectPointer<Matrix>(5, "Matrix", false, &param5Valid);
                    if (!param5Valid)
                        break;
        ...
        case 10:
        {
            do
            {
                    ...
                    (lua_type(state, 10) == LUA_TUSERDATA || lua_type(state, 10) == LUA_TTABLE || lua_type(state, 10) == LUA_TNIL))
                {
                    ...
                    // Get parameter 10 off the stack.
                    bool param10Valid;
                    egret::ScriptUtil::LuaArray<Matrix> param10 = egret::ScriptUtil::getObjectPointer<Matrix>(10, "Matrix", false, &param10Valid);
                    if (!param10Valid)
                        break;
    ...
    switch (paramCount)
    {
        case 7:
        {
                ...
                (lua_type(state, 7) == LUA_TUSERDATA || lua_type(state, 7) == LUA_TTABLE || lua_type(state, 7) == LUA_TNIL))
            {
                ...
                // Get parameter 7 off the stack.
                bool param7Valid;
                egret::ScriptUtil::LuaArray<Matrix> param7 = egret::ScriptUtil::getObjectPointer<Matrix>(7, "Matrix", false, &param7Valid);
                if (!param7Valid)
                {
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                // Get parameter 2 off the stack.
                bool param2Valid;
                egret::ScriptUtil::LuaArray<Matrix> param2 = egret::ScriptUtil::getObjectPointer<Matrix>(2, "Matrix", false, &param2Valid);
                if (!param2Valid)
                {
                    lua_pushstring(state, "Failed to convert parameter 2 to type 'Matrix'.");
                    lua_error(state);
        ...
        case 2:
        {
            do
            {
                    ...
                    (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Quaternion> param1 = egret::ScriptUtil::getObjectPointer<Quaternion>(1, "Quaternion", true, &param1Valid);
                    if (!param1Valid)
                        break;
