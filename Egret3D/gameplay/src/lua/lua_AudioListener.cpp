...
void luaRegister_AudioListener()
{
    ...
    egret::ScriptUtil::registerClass("AudioListener", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static AudioListener* getInstance(lua_State* state)
{
    ...
    return (AudioListener*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
