...
void luaRegister_MeshBatch()
{
    ...
    egret::ScriptUtil::registerClass("MeshBatch", lua_members, NULL, lua_MeshBatch__gc, lua_statics, scopePath);
}
...
static MeshBatch* getInstance(lua_State* state)
{
    ...
    return (MeshBatch*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 4:
        {
            do
            {
                    ...
                    lua_type(state, 4) == LUA_TBOOLEAN)
                {
                    ...
                    // Get parameter 4 off the stack.
                    bool param4 = egret::ScriptUtil::luaCheckBool(state, 4);
            ...
            do
            {
                    ...
                    lua_type(state, 4) == LUA_TBOOLEAN)
                {
                    ...
                    // Get parameter 3 off the stack.
                    bool param3Valid;
                    egret::ScriptUtil::LuaArray<Material> param3 = egret::ScriptUtil::getObjectPointer<Material>(3, "Material", false, &param3Valid);
                    if (!param3Valid)
                        break;
