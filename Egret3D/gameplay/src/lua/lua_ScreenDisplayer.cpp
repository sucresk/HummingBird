...
void luaRegister_ScreenDisplayer()
{
    ...
    egret::ScriptUtil::registerClass("ScreenDisplayer", lua_members, lua_ScreenDisplayer__init, lua_ScreenDisplayer__gc, lua_statics, scopePath);
}
...
static ScreenDisplayer* getInstance(lua_State* state)
{
    ...
    return (ScreenDisplayer*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
