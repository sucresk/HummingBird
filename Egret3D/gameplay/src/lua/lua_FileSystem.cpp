...
void luaRegister_FileSystem()
{
    ...
    egret::ScriptUtil::registerClass("FileSystem", lua_members, NULL, lua_FileSystem__gc, lua_statics, scopePath);
}
...
static FileSystem* getInstance(lua_State* state)
{
    ...
    return (FileSystem*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        ...
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TLIGHTUSERDATA))
            {
                ...
                egret::ScriptUtil::LuaArray<int> param2 = egret::ScriptUtil::getIntPointer(2);
