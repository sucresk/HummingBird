...
void luaRegister_AIMessage()
{
    ...
    egret::ScriptUtil::registerClass("AIMessage", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static AIMessage* getInstance(lua_State* state)
{
    ...
    return (AIMessage*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 1:
        {
            if ((lua_type(state, 1) == LUA_TUSERDATA || lua_type(state, 1) == LUA_TTABLE || lua_type(state, 1) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<AIMessage> param1 = egret::ScriptUtil::getObjectPointer<AIMessage>(1, "AIMessage", false, &param1Valid);
                if (!param1Valid)
                {
