...
void luaRegister_Game()
{
    ...
    egret::ScriptUtil::registerClass("Game", lua_members, lua_Game__init, lua_Game__gc, lua_statics, scopePath);
}
...
static Game* getInstance(lua_State* state)
{
    ...
    return (Game*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                // Get parameter 2 off the stack.
                bool param2Valid;
                egret::ScriptUtil::LuaArray<Gamepad> param2 = egret::ScriptUtil::getObjectPointer<Gamepad>(3, "Gamepad", false, &param2Valid);
                if (!param2Valid)
                {
...
int lua_Game_static_setVsync(lua_State* state)
{
    ...
    switch (paramCount)
    {
        case 1:
        {
            ...
            {
                // Get parameter 1 off the stack.
                bool param1 = egret::ScriptUtil::luaCheckBool(state, 1);
