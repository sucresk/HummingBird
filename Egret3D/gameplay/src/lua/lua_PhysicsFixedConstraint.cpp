...
void luaRegister_PhysicsFixedConstraint()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsFixedConstraint", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static PhysicsFixedConstraint* getInstance(lua_State* state)
{
    ...
    return (PhysicsFixedConstraint*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
				...
				kmVec3 temp = PhysicsFixedConstraint::centerOfMassMidpoint(param1, param2);
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TNIL))
            {
				...
				kmQuaternion temp = PhysicsFixedConstraint::getRotationOffset(param1, *param2);
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TNIL))
            {
				...
				kmVec3* returnPtr = new kmVec3;
				kmVec3 temp = PhysicsFixedConstraint::getTranslationOffset(param1, *param2);
				memcpy(returnPtr, &temp, sizeof(float) * 3);
                if (returnPtr)
                {
                    egret::ScriptUtil::LuaObject* object = (egret::ScriptUtil::LuaObject*)lua_newuserdata(state, sizeof(egret::ScriptUtil::LuaObject));
