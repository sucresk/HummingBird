...
void luaRegister_PhysicsControllerHitResult()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsControllerHitResult", lua_members, lua_PhysicsControllerHitResult__init, lua_PhysicsControllerHitResult__gc, lua_statics, scopePath);
}
...
static PhysicsController::HitResult* getInstance(lua_State* state)
{
    ...
    return (PhysicsController::HitResult*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
