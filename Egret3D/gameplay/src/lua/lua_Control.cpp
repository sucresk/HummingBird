...
void luaRegister_Control()
{
    ...
    egret::ScriptUtil::registerClass("Control", lua_members, NULL, lua_Control__gc, lua_statics, scopePath);
}
...
static Control* getInstance(lua_State* state)
{
    ...
    return (Control*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
