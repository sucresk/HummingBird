...
void luaRegister_ScriptController()
{
    ...
    egret::ScriptUtil::registerClass("ScriptController", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static ScriptController* getInstance(lua_State* state)
{
    ...
    return (ScriptController*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        ...
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                bool param2Valid;
                egret::ScriptUtil::LuaArray<Script> param2 = egret::ScriptUtil::getObjectPointer<Script>(3, "Script", false, &param2Valid);
                if (!param2Valid)
                {
