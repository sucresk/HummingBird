...
void luaRegister_VertexAttributeBinding()
{
    ...
    egret::ScriptUtil::registerClass("VertexAttributeBinding", lua_members, NULL, lua_VertexAttributeBinding__gc, lua_statics, scopePath);
}
...
static VertexAttributeBinding* getInstance(lua_State* state)
{
    ...
    return (VertexAttributeBinding*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
