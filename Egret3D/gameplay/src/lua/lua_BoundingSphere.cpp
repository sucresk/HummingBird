...
void luaRegister_BoundingSphere()
{
    ...
    egret::ScriptUtil::registerClass("BoundingSphere", lua_members, lua_BoundingSphere__init, lua_BoundingSphere__gc, lua_statics, scopePath);
}
...
static BoundingSphere* getInstance(lua_State* state)
{
    ...
    return (BoundingSphere*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 1:
        {
            do
            {
                if ((lua_type(state, 1) == LUA_TUSERDATA || lua_type(state, 1) == LUA_TNIL))
                {
                    ...
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<BoundingSphere> param1 = egret::ScriptUtil::getObjectPointer<BoundingSphere>(1, "BoundingSphere", true, &param1Valid);
                    if (!param1Valid)
                        break;
