...
void luaRegister_RenderStateStateBlock()
{
    ...
    egret::ScriptUtil::registerClass("RenderStateStateBlock", lua_members, NULL, lua_RenderStateStateBlock__gc, lua_statics, scopePath);
}
...
static RenderState::StateBlock* getInstance(lua_State* state)
{
    ...
    return (RenderState::StateBlock*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
