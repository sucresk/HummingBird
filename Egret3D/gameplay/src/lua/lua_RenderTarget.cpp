...
void luaRegister_RenderTarget()
{
    ...
    egret::ScriptUtil::registerClass("RenderTarget", lua_members, NULL, lua_RenderTarget__gc, lua_statics, scopePath);
}
...
static RenderTarget* getInstance(lua_State* state)
{
    ...
    return (RenderTarget*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 2:
        {
            do
            {
                    ...
                    (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
                {
                    ...
                    bool param2Valid;
                    egret::ScriptUtil::LuaArray<Texture> param2 = egret::ScriptUtil::getObjectPointer<Texture>(2, "Texture", false, &param2Valid);
                    if (!param2Valid)
                        break;
