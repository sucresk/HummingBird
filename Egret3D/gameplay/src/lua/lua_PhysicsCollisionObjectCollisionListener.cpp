...
void luaRegister_PhysicsCollisionObjectCollisionListener()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsCollisionObjectCollisionListener", lua_members, NULL, lua_PhysicsCollisionObjectCollisionListener__gc, lua_statics, scopePath);
}
...
static PhysicsCollisionObject::CollisionListener* getInstance(lua_State* state)
{
    ...
    return (PhysicsCollisionObject::CollisionListener*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                bool param2Valid;
                egret::ScriptUtil::LuaArray<PhysicsCollisionObject::CollisionPair> param2 = egret::ScriptUtil::getObjectPointer<PhysicsCollisionObject::CollisionPair>(3, "PhysicsCollisionObjectCollisionPair", true, &param2Valid);
                if (!param2Valid)
                {
