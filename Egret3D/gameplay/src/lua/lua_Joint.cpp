...
void luaRegister_Joint()
{
    ...
    egret::ScriptUtil::registerClass("Joint", lua_members, NULL, lua_Joint__gc, lua_statics, scopePath);
}
...
static Joint* getInstance(lua_State* state)
{
    ...
    return (Joint*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Node> param1 = egret::ScriptUtil::getObjectPointer<Node>(2, "Node", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Transform::Listener> param1 = egret::ScriptUtil::getObjectPointer<Transform::Listener>(2, "TransformListener", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TSTRING || lua_type(state, 3) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<ScriptTarget::Event> param1 = egret::ScriptUtil::getObjectPointer<ScriptTarget::Event>(2, "ScriptTargetEvent", false, &param1Valid);
                if (!param1Valid)
                {
                ...
                // Get parameter 2 off the stack.
                const char* param2 = egret::ScriptUtil::getString(3, false);
        ...
        case 3:
        {
            ...
            do
            {
                    ...
                    (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
                {
                    ...
                    // Get parameter 2 off the stack.
                    bool param2Valid;
                    egret::ScriptUtil::LuaArray<Properties> param2 = egret::ScriptUtil::getObjectPointer<Properties>(3, "Properties", false, &param2Valid);
                    if (!param2Valid)
                        break;
        ...
        case 7:
        {
            do
            {
                    ...
                    lua_type(state, 7) == LUA_TNUMBER)
                {
                    ...
                    egret::ScriptUtil::LuaArray<unsigned int> param4 = egret::ScriptUtil::getUnsignedIntPointer(5);

                    // Get parameter 5 off the stack.
                    egret::ScriptUtil::LuaArray<float> param5 = egret::ScriptUtil::getFloatPointer(6);
        ...
        case 9:
        {
            do
            {
                    ...
                    lua_type(state, 9) == LUA_TNUMBER)
                {
                    ...
                    // Get parameter 6 off the stack.
                    egret::ScriptUtil::LuaArray<float> param6 = egret::ScriptUtil::getFloatPointer(7);

                    // Get parameter 7 off the stack.
                    egret::ScriptUtil::LuaArray<float> param7 = egret::ScriptUtil::getFloatPointer(8);
    ...
    switch (paramCount)
    {
        case 7:
        {
                ...
                lua_type(state, 7) == LUA_TNUMBER)
            {
                ...
                // Get parameter 3 off the stack.
                egret::ScriptUtil::LuaArray<float> param3 = egret::ScriptUtil::getFloatPointer(4);

                // Get parameter 4 off the stack.
                egret::ScriptUtil::LuaArray<float> param4 = egret::ScriptUtil::getFloatPointer(5);
    ...
    switch (paramCount)
    {
        ...
        case 3:
        {
                ...
                lua_type(state, 3) == LUA_TBOOLEAN)
            {
                ...
                // Get parameter 2 off the stack.
                bool param2 = egret::ScriptUtil::luaCheckBool(state, 3);
        ...
        case 4:
        {
                ...
                lua_type(state, 4) == LUA_TBOOLEAN)
            {
                ...
                // Get parameter 3 off the stack.
                bool param3 = egret::ScriptUtil::luaCheckBool(state, 4);
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                // Get parameter 2 off the stack.
                bool param2Valid;
                egret::ScriptUtil::LuaArray<AnimationValue> param2 = egret::ScriptUtil::getObjectPointer<AnimationValue>(3, "AnimationValue", false, &param2Valid);
                if (!param2Valid)
                {
        ...
        case 2:
        {
            do
            {
                    ...
                    (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TNIL))
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Transform> param1 = egret::ScriptUtil::getObjectPointer<Transform>(2, "Transform", true, &param1Valid);
                    if (!param1Valid)
                        break;
        ...
        case 4:
        {
            do
            {
                    ...
                    (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TNIL))
                {
                    ...
                    // Get parameter 3 off the stack.
                    bool param3Valid;
                    egret::ScriptUtil::LuaArray<kmVec3> param3 = egret::ScriptUtil::getObjectPointer<kmVec3>(4, "kmVec3", true, &param3Valid);
                    if (!param3Valid)
                        break;
        ...
        case 5:
        {
            do
            {
                    ...
                    (lua_type(state, 5) == LUA_TUSERDATA || lua_type(state, 5) == LUA_TNIL))
                {
                    ...
                    // Get parameter 4 off the stack.
                    bool param4Valid;
                    egret::ScriptUtil::LuaArray<kmVec3> param4 = egret::ScriptUtil::getObjectPointer<kmVec3>(5, "kmVec3", true, &param4Valid);
                    if (!param4Valid)
                        break;
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<AIAgent> param1 = egret::ScriptUtil::getObjectPointer<AIAgent>(2, "AIAgent", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<AudioSource> param1 = egret::ScriptUtil::getObjectPointer<AudioSource>(2, "AudioSource", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Camera> param1 = egret::ScriptUtil::getObjectPointer<Camera>(2, "Camera", false, &param1Valid);
                if (!param1Valid)
                {
        ...
        case 3:
        {
            do
            {
                    ...
                    (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TNIL))
                {
                    ...
                    // Get parameter 2 off the stack.
                    bool param2Valid;
                    egret::ScriptUtil::LuaArray<PhysicsCollisionShape::Definition> param2 = egret::ScriptUtil::getObjectPointer<PhysicsCollisionShape::Definition>(3, "PhysicsCollisionShapeDefinition", true, &param2Valid);
                    if (!param2Valid)
                        break;
        ...
        case 4:
        {
            do
            {
                    ...
                    (lua_type(state, 4) == LUA_TUSERDATA || lua_type(state, 4) == LUA_TTABLE || lua_type(state, 4) == LUA_TNIL))
                {
                    ...
                    // Get parameter 3 off the stack.
                    bool param3Valid;
                    egret::ScriptUtil::LuaArray<PhysicsRigidBody::Parameters> param3 = egret::ScriptUtil::getObjectPointer<PhysicsRigidBody::Parameters>(4, "PhysicsRigidBodyParameters", false, &param3Valid);
                    if (!param3Valid)
                        break;
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Drawable> param1 = egret::ScriptUtil::getObjectPointer<Drawable>(2, "Drawable", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Light> param1 = egret::ScriptUtil::getObjectPointer<Light>(2, "Light", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                // Get parameter 1 off the stack.
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Ref> param1 = egret::ScriptUtil::getObjectPointer<Ref>(2, "Ref", false, &param1Valid);
                if (!param1Valid)
                {
