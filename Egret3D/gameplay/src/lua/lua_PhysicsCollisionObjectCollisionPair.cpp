...
void luaRegister_PhysicsCollisionObjectCollisionPair()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsCollisionObjectCollisionPair", lua_members, lua_PhysicsCollisionObjectCollisionPair__init, lua_PhysicsCollisionObjectCollisionPair__gc, lua_statics, scopePath);
}
...
static PhysicsCollisionObject::CollisionPair* getInstance(lua_State* state)
{
    ...
    return (PhysicsCollisionObject::CollisionPair*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                bool param1Valid;
                egret::ScriptUtil::LuaArray<PhysicsCollisionObject> param1 = egret::ScriptUtil::getObjectPointer<PhysicsCollisionObject>(1, "PhysicsCollisionObject", false, &param1Valid);
                if (!param1Valid)
                {
                ...
                bool param2Valid;
                egret::ScriptUtil::LuaArray<PhysicsCollisionObject> param2 = egret::ScriptUtil::getObjectPointer<PhysicsCollisionObject>(2, "PhysicsCollisionObject", false, &param2Valid);
                if (!param2Valid)
                {
