...
void luaRegister_TextureSampler()
{
    ...
    egret::ScriptUtil::registerClass("TextureSampler", lua_members, NULL, lua_TextureSampler__gc, lua_statics, scopePath);
}
...
static Texture::Sampler* getInstance(lua_State* state)
{
    ...
    return (Texture::Sampler*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
