...
void luaRegister_SpriteBatchSpriteVertex()
{
    ...
    egret::ScriptUtil::registerClass("SpriteBatchSpriteVertex", lua_members, lua_SpriteBatchSpriteVertex__init, lua_SpriteBatchSpriteVertex__gc, lua_statics, scopePath);
}
...
static SpriteBatch::SpriteVertex* getInstance(lua_State* state)
{
    ...
    return (SpriteBatch::SpriteVertex*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
