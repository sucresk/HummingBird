...
void luaRegister_Container()
{
    ...
    egret::ScriptUtil::registerClass("Container", lua_members, NULL, lua_Container__gc, lua_statics, scopePath);
}
...
static Container* getInstance(lua_State* state)
{
    ...
    return (Container*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
