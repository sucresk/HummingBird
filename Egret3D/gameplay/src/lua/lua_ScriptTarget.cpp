...
void luaRegister_ScriptTarget()
{
    ...
    egret::ScriptUtil::registerClass("ScriptTarget", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static ScriptTarget* getInstance(lua_State* state)
{
    ...
    return (ScriptTarget*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
