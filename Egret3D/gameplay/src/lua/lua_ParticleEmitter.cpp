...
void luaRegister_ParticleEmitter()
{
    ...
    egret::ScriptUtil::registerClass("ParticleEmitter", lua_members, NULL, lua_ParticleEmitter__gc, lua_statics, scopePath);
}
...
static ParticleEmitter* getInstance(lua_State* state)
{
    ...
    return (ParticleEmitter*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 3:
        {
            do
            {
                    ...
                    (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
                {
                    ...
                    // Get parameter 2 off the stack.
                    bool param2Valid;
                    egret::ScriptUtil::LuaArray<Rectangle> param2 = egret::ScriptUtil::getObjectPointer<Rectangle>(3, "Rectangle", false, &param2Valid);
                    if (!param2Valid)
                        break;
        ...
        case 3:
        {
            ...
            do
            {
                    ...
                    lua_type(state, 3) == LUA_TNUMBER)
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<Texture> param1 = egret::ScriptUtil::getObjectPointer<Texture>(2, "Texture", false, &param1Valid);
                    if (!param1Valid)
                        break;
