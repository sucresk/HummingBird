...
void luaRegister_AnimationController()
{
    ...
    egret::ScriptUtil::registerClass("AnimationController", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static AnimationController* getInstance(lua_State* state)
{
    ...
    return (AnimationController*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
