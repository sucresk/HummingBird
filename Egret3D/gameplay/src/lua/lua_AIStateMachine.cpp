...
void luaRegister_AIStateMachine()
{
    ...
    egret::ScriptUtil::registerClass("AIStateMachine", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static AIStateMachine* getInstance(lua_State* state)
{
    ...
    return (AIStateMachine*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 2:
        {
            ...
            do
            {
                    ...
                    (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
                {
                    // Get parameter 1 off the stack.
                    bool param1Valid;
                    egret::ScriptUtil::LuaArray<AIState> param1 = egret::ScriptUtil::getObjectPointer<AIState>(2, "AIState", false, &param1Valid);
                    if (!param1Valid)
                        break;
