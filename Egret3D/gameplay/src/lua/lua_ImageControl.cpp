...
void luaRegister_ImageControl()
{
    ...
    egret::ScriptUtil::registerClass("ImageControl", lua_members, NULL, lua_ImageControl__gc, lua_statics, scopePath);
}
...
static ImageControl* getInstance(lua_State* state)
{
    ...
    return (ImageControl*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
