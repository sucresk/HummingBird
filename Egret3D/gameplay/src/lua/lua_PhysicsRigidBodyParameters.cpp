...
void luaRegister_PhysicsRigidBodyParameters()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsRigidBodyParameters", lua_members, lua_PhysicsRigidBodyParameters__init, lua_PhysicsRigidBodyParameters__gc, lua_statics, scopePath);
}
...
static PhysicsRigidBody::Parameters* getInstance(lua_State* state)
{
    ...
    return (PhysicsRigidBody::Parameters*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
        ...
        case 6:
        {
            do
            {
                    ...
                    lua_type(state, 6) == LUA_TBOOLEAN)
                {
                    ...
                    bool param6 = egret::ScriptUtil::luaCheckBool(state, 6);
