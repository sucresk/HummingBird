...
void luaRegister_NodeCloneContext()
{
    ...
    egret::ScriptUtil::registerClass("NodeCloneContext", lua_members, lua_NodeCloneContext__init, lua_NodeCloneContext__gc, lua_statics, scopePath);
}
...
static NodeCloneContext* getInstance(lua_State* state)
{
    ...
    return (NodeCloneContext*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
    ...
    switch (paramCount)
    {
        case 2:
        {
                ...
                (lua_type(state, 2) == LUA_TUSERDATA || lua_type(state, 2) == LUA_TTABLE || lua_type(state, 2) == LUA_TNIL))
            {
                ...
                bool param1Valid;
                egret::ScriptUtil::LuaArray<Animation> param1 = egret::ScriptUtil::getObjectPointer<Animation>(2, "Animation", false, &param1Valid);
                if (!param1Valid)
                {
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                bool param2Valid;
                egret::ScriptUtil::LuaArray<Animation> param2 = egret::ScriptUtil::getObjectPointer<Animation>(3, "Animation", false, &param2Valid);
                if (!param2Valid)
                {
    ...
    switch (paramCount)
    {
        case 3:
        {
                ...
                (lua_type(state, 3) == LUA_TUSERDATA || lua_type(state, 3) == LUA_TTABLE || lua_type(state, 3) == LUA_TNIL))
            {
                ...
                // Get parameter 2 off the stack.
                bool param2Valid;
                egret::ScriptUtil::LuaArray<Node> param2 = egret::ScriptUtil::getObjectPointer<Node>(3, "Node", false, &param2Valid);
                if (!param2Valid)
                {
