...
void luaRegister_AudioSource()
{
    ...
    egret::ScriptUtil::registerClass("AudioSource", lua_members, NULL, lua_AudioSource__gc, lua_statics, scopePath);
}
...
static AudioSource* getInstance(lua_State* state)
{
    ...
    return (AudioSource*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
