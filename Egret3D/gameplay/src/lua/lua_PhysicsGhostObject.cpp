...
void luaRegister_PhysicsGhostObject()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsGhostObject", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static PhysicsGhostObject* getInstance(lua_State* state)
{
    ...
    return (PhysicsGhostObject*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
