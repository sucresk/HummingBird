...
void luaRegister_AnimationClipListener()
{
    ...
    egret::ScriptUtil::registerClass("AnimationClipListener", lua_members, NULL, lua_AnimationClipListener__gc, lua_statics, scopePath);
}
...
static AnimationClip::Listener* getInstance(lua_State* state)
{
    ...
    return (AnimationClip::Listener*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
