...
void luaRegister_PhysicsVehicleWheel()
{
    ...
    egret::ScriptUtil::registerClass("PhysicsVehicleWheel", lua_members, NULL, NULL, lua_statics, scopePath);
}
...
static PhysicsVehicleWheel* getInstance(lua_State* state)
{
    ...
    return (PhysicsVehicleWheel*)((egret::ScriptUtil::LuaObject*)userdata)->instance;
}
