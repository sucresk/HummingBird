...
static egret::Keyboard::Key getKey(WPARAM win32KeyCode, bool shiftDown)
{
    switch (win32KeyCode)
    {
    case VK_PAUSE:
    ...
    case VK_TAB:
        return shiftDown ? egret::Keyboard::KEY_BACK_TAB : egret::Keyboard::KEY_TAB;
    case VK_RETURN:
    ...
    case VK_BROWSER_SEARCH:
        return egret::Keyboard::KEY_SEARCH;
    case VK_INSERT:
    ...
    case 0x30:
        return shiftDown ? egret::Keyboard::KEY_RIGHT_PARENTHESIS : egret::Keyboard::KEY_ZERO;
    case 0x31:
        return shiftDown ? egret::Keyboard::KEY_EXCLAM : egret::Keyboard::KEY_ONE;
    case 0x32:
        return shiftDown ? egret::Keyboard::KEY_AT : egret::Keyboard::KEY_TWO;
    case 0x33:
        return shiftDown ? egret::Keyboard::KEY_NUMBER : egret::Keyboard::KEY_THREE;
    case 0x34:
        return shiftDown ? egret::Keyboard::KEY_DOLLAR : egret::Keyboard::KEY_FOUR;
    case 0x35:
        return shiftDown ? egret::Keyboard::KEY_PERCENT : egret::Keyboard::KEY_FIVE;
    case 0x36:
        return shiftDown ? egret::Keyboard::KEY_CIRCUMFLEX : egret::Keyboard::KEY_SIX;
    case 0x37:
        return shiftDown ? egret::Keyboard::KEY_AMPERSAND : egret::Keyboard::KEY_SEVEN;
    case 0x38:
        return shiftDown ? egret::Keyboard::KEY_ASTERISK : egret::Keyboard::KEY_EIGHT;
    case 0x39:
        return shiftDown ? egret::Keyboard::KEY_LEFT_PARENTHESIS : egret::Keyboard::KEY_NINE;
    case VK_OEM_PLUS:
        return shiftDown ? egret::Keyboard::KEY_EQUAL : egret::Keyboard::KEY_PLUS;
    case VK_OEM_COMMA:
        return shiftDown ? egret::Keyboard::KEY_LESS_THAN : egret::Keyboard::KEY_COMMA;
    case VK_OEM_MINUS:
        return shiftDown ? egret::Keyboard::KEY_UNDERSCORE : egret::Keyboard::KEY_MINUS;
    case VK_OEM_PERIOD:
        return shiftDown ? egret::Keyboard::KEY_GREATER_THAN : egret::Keyboard::KEY_PERIOD;
    case VK_OEM_1:
        return shiftDown ? egret::Keyboard::KEY_COLON : egret::Keyboard::KEY_SEMICOLON;
    case VK_OEM_2:
        return shiftDown ? egret::Keyboard::KEY_QUESTION : egret::Keyboard::KEY_SLASH;
    case VK_OEM_3:
        return shiftDown ? egret::Keyboard::KEY_TILDE : egret::Keyboard::KEY_GRAVE;
    case VK_OEM_4:
        return shiftDown ? egret::Keyboard::KEY_LEFT_BRACE : egret::Keyboard::KEY_LEFT_BRACKET;
    case VK_OEM_5:
        return shiftDown ? egret::Keyboard::KEY_BAR : egret::Keyboard::KEY_BACK_SLASH;
    case VK_OEM_6:
        return shiftDown ? egret::Keyboard::KEY_RIGHT_BRACE : egret::Keyboard::KEY_RIGHT_BRACKET;
    case VK_OEM_7:
        return shiftDown ? egret::Keyboard::KEY_QUOTE : egret::Keyboard::KEY_APOSTROPHE;
    case 0x41:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_A : egret::Keyboard::KEY_A;
    case 0x42:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_B : egret::Keyboard::KEY_B;
    case 0x43:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_C : egret::Keyboard::KEY_C;
    case 0x44:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_D : egret::Keyboard::KEY_D;
    case 0x45:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_E : egret::Keyboard::KEY_E;
    case 0x46:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_F : egret::Keyboard::KEY_F;
    case 0x47:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_G : egret::Keyboard::KEY_G;
    case 0x48:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_H : egret::Keyboard::KEY_H;
    case 0x49:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_I : egret::Keyboard::KEY_I;
    case 0x4A:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_J : egret::Keyboard::KEY_J;
    case 0x4B:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_K : egret::Keyboard::KEY_K;
    case 0x4C:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_L : egret::Keyboard::KEY_L;
    case 0x4D:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_M : egret::Keyboard::KEY_M;
    case 0x4E:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_N : egret::Keyboard::KEY_N;
    case 0x4F:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_O : egret::Keyboard::KEY_O;
    case 0x50:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_P : egret::Keyboard::KEY_P;
    case 0x51:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_Q : egret::Keyboard::KEY_Q;
    case 0x52:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_R : egret::Keyboard::KEY_R;
    case 0x53:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_S : egret::Keyboard::KEY_S;
    case 0x54:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_T : egret::Keyboard::KEY_T;
    case 0x55:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_U : egret::Keyboard::KEY_U;
    case 0x56:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_V : egret::Keyboard::KEY_V;
    case 0x57:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_W : egret::Keyboard::KEY_W;
    case 0x58:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_X : egret::Keyboard::KEY_X;
    case 0x59:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_Y : egret::Keyboard::KEY_Y;
    case 0x5A:
        return shiftDown ? egret::Keyboard::KEY_CAPITAL_Z : egret::Keyboard::KEY_Z;
    default:
...
{
    static egret::Game* game = egret::Game::getInstance();
    ...
    case WM_DESTROY:
        egret::Platform::shutdownInternal();
        PostQuitMessage(0);
        return 0;
    ...
    case WM_LBUTTONDOWN:
    {
        ...
        if (!egret::Platform::mouseEventInternal(egret::Mouse::MOUSE_PRESS_LEFT_BUTTON, x, y, 0))
        {
            egret::Platform::touchEventInternal(egret::Touch::TOUCH_PRESS, x, y, 0, true);
        }
        return 0;
    }
    case WM_LBUTTONUP:
    {
        ...
        if (!egret::Platform::mouseEventInternal(egret::Mouse::MOUSE_RELEASE_LEFT_BUTTON, x, y, 0))
        {
            egret::Platform::touchEventInternal(egret::Touch::TOUCH_RELEASE, x, y, 0, true);
        }
        UpdateCapture(wParam);
        return 0;
    }
    case WM_RBUTTONDOWN:
        UpdateCapture(wParam);
        egret::Platform::mouseEventInternal(egret::Mouse::MOUSE_PRESS_RIGHT_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
        break;

    case WM_RBUTTONUP:
        egret::Platform::mouseEventInternal(egret::Mouse::MOUSE_RELEASE_RIGHT_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
        UpdateCapture(wParam);
        break;

    case WM_MBUTTONDOWN:
        UpdateCapture(wParam);
        egret::Platform::mouseEventInternal(egret::Mouse::MOUSE_PRESS_MIDDLE_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
        break;

    case WM_MBUTTONUP:
        egret::Platform::mouseEventInternal(egret::Mouse::MOUSE_RELEASE_MIDDLE_BUTTON, GET_X_LPARAM(lParam), GET_Y_LPARAM(lParam), 0);
        UpdateCapture(wParam);
        break;
    ...
    case WM_MOUSEWHEEL:
        ...
        egret::Platform::mouseEventInternal(egret::Mouse::MOUSE_WHEEL, point.x, point.y, GET_WHEEL_DELTA_WPARAM(wParam) / 120);
        break;
    ...
    case WM_KEYDOWN:
        ...
        egret::Platform::keyEventInternal(egret::Keyboard::KEY_PRESS, getKey(wParam, shiftDown ^ capsOn));
        break;
    ...
    case WM_KEYUP:
        ...
        egret::Platform::keyEventInternal(egret::Keyboard::KEY_RELEASE, getKey(wParam, shiftDown ^ capsOn));
        break;

    case WM_CHAR:
        egret::Platform::keyEventInternal(egret::Keyboard::KEY_CHAR, wParam);
        break;
    ...
    case WM_SIZE:
        // Window was resized.
        egret::Platform::resizeEventInternal((unsigned int)(short)LOWORD(lParam), (unsigned int)(short)HIWORD(lParam));
        break;
    }
