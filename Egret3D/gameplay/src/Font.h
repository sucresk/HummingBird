...
public:
     ...
     */
    void drawText(const char* text, int x, int y, const kmVec4& color, unsigned int size = 0,
     ...
     */
    void drawText(const char* text, const Rectangle& area, const kmVec4& color, unsigned int size = 0,
